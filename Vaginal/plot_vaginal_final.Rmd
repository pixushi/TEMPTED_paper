...
p_feat_ratio_summary <- plot_feature_summary(feature_mat_ratio, 
  ...
  theme(strip.text = element_blank(), 
        strip.background = element_blank()) + ylim(3.5,8.3)
...
```{r subj_loading, fig.height=2.5, fig.width=10}
...
pdf('../figure_table/vaginal_plot.pdf', width=10, height=2.5)
...
```{r simulation, fig.width=9, fig.height=4}
...
pdf("../figure_table/realsim_vaginal_Fvalue.pdf", width=9, height=3.5)
